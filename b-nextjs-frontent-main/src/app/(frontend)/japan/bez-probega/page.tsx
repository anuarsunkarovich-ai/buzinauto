...
export const metadata = {
  description: generateDescription.begin('автомобиль из Японии без пробега'),
  title: generateTitle.endJapan('без пробега'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    >
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.endJapan('без пробега')}</Title>
        <FilterAuto />
