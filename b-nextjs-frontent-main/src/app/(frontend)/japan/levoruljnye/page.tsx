...
export const metadata = {
  description: generateDescription.begin('леворульные автомобиль из Японии'),
  title: generateTitle.middleJapan('леворульные авто', 'Купить'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    >
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.endJapan('', 'Леворульные автомобили')}</Title>
        <FilterAuto />
