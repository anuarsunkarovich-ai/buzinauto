...
export const metadata = {
  description: generateDescription.begin('автомобиль из Японии'),
  title: generateTitle.endJapan(),
  alternates: {
    canonical: './',
  },
}
...
export default async function HomePage({
  ...
  return (
    ...
    >
      <Header />
      <BoxContainer>
        <AppBreadcrumb items={[HOME_BREADCRUMB, JAPAN_CAR_ROOT]} />
        <Title as="h1">{generateH1.endJapan()}</Title>
        <NavButtons />
        <FilterAuto
          defaultValues={{
