...
export const metadata = {
  description: generateDescription.begin('автомобиль под заказ из Японии'),
  title: generateTitle.endJapan('под заказ', 'Купить авто'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    >
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.endJapan('под заказ', 'Автомобили')}</Title>
        <FilterAuto />
