...
export const metadata = {
  description: generateDescription.begin('праворульный автомобиль из Японии'),
  title: generateTitle.middleJapan('праворульные авто', 'Купить'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    >
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.endJapan('', 'Праворульные автомобили')}</Title>
        <FilterAuto />
