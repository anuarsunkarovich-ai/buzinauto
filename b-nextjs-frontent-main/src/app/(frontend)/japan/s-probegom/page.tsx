...
export const metadata = {
  description: generateDescription.begin('автомобиль из Японии с пробегом'),
  title: generateTitle.endJapan('с пробегом'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    `}>
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.endJapan('с пробегом')}</Title>
        <FilterAuto />
