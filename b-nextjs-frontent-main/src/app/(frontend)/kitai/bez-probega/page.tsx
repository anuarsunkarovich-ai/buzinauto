...
export const metadata = {
  description: generateDescription.begin('автомобиль из Китай без пробега'),
  title: generateTitle.endChina('без пробега'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    `}>
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.endChina('без пробега')}</Title>
        <FilterAuto />
