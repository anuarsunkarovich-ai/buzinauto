...
export const metadata = {
  description: generateDescription.begin('автомобилей с аукционов Китая', 'Каталог'),
  title: generateTitle.middleAuctionChina('авто', 'Каталог'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    >
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.middleAuctionChina('автомобилей', 'Каталог')}</Title>
        <FilterAuto />
