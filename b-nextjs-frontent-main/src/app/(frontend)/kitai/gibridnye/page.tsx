...
export const metadata = {
  description: generateDescription.begin('гибридные автомобили из Китая'),
  title: generateTitle.middleChina('гибридные авто', 'Купить'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    >
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.middleChina('автомобили', 'Гибридные')}</Title>
        <FilterAuto />
