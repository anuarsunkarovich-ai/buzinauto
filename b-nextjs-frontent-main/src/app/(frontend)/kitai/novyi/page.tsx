...
export const metadata = {
  description: generateDescription.begin('новые автомобили из Китая'),
  title: generateTitle.middleChina('новый авто', 'Купить'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    >
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.middleChina('автомобили', 'Новые')}</Title>
        <FilterAuto />
