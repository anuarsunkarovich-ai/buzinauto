...
export const metadata = {
  description: generateDescription.begin('автомобиль из Китая с пробегом'),
  title: generateTitle.endChina('с пробегом'),
  alternates: {
    canonical: './',
  },
}
  ...
  return (
    ...
    `}>
      ...
      <BoxContainer>
        ...
        <Title as="h1">{generateH1.endChina('с пробегом')}</Title>
        <FilterAuto />
