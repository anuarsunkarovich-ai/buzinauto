...
import { HOME_BREADCRUMB, HOME_PRIVACY } from '@/constants/breadcrumb'
import { Metadata } from 'next'
import Link from 'next/link'

const siteURL = process.env.PAYLOAD_URL || 'https://nrg-auto.ru'
...
export default async function Page() {
  return (
    ...
    >
      ...
      <BoxContainer>
        <AppBreadcrumb items={[HOME_BREADCRUMB, HOME_PRIVACY]} />
        <Title as="h1" usingStyleFrom="h2">
          Политика в отношении обработки персональных данных
        </Title>
      </BoxContainer>
      <BoxContainer className="md:space-y-4">
        <div>
          <Title as="h2" usingStyleFrom="h3">
            1. Общие положения
          </Title>
          <Text>
            ...
            по обеспечению безопасности персональных данных, предпринимаемые ИП Бузин Алексей
            Сергеевич (далее — Оператор).
          </Text>
          <ol
            className={`
              ml-6 list-inside list-none
              [&>li]:mt-2
            `}
          >
            <li>
            ...
            <li>
              ...
              <Link className="font-medium underline underline-offset-4" href={siteURL}>
                {siteURL}
              </Link>
              .
            </li>
              ...
              <tbody>
                ...
                >
                  ...
                  >
                    <ol
                      className={`
                        my-6 ml-6 list-inside list-disc
                        [&>li]:mt-2
                      `}
                    >
          ...
          >
            ...
            <li>
              ...
              <Link
                ...
                href={siteURL + HOME_PRIVACY.path}
              >
                {siteURL + HOME_PRIVACY.path}
              </Link>
              .
            </li>
          </ol>
